...
REM    0) download_diario  -> baixa o D.O. do dia (Playwright)
REM    1) index_build --latest -> MinerU extrai + indexa a Parte I
REM    2) ler_cadernos     -> indexa os cadernos IB/II/IV/V
REM    3) exonerar         -> Excel das exoneracoes
