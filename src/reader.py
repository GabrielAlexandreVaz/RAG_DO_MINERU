...
SYSTEM = (
    ...
    "- 'id_funcional': o ID Funcional / matricula / IF do servidor, EXATAMENTE como no "
    "texto (ex.: 'ID FUNCIONAL No 51087316' -> 51087316; 'IF 4417576-0' -> 4417576-0; "
    "inclua o digito de vinculo se houver, ex.: 43819460/2). \"\" se nao houver.\n"
